...
public abstract class FetchedState extends AbstractState {
    ...
    public void initTxtAccountState(AccountDetailFrame frame) {
        ...
        txtAccountState.setText(this.getAccount().getState());
    }
    ...
    public void initTxtBalance(AccountDetailFrame frame) {
        JTextField txtBalanceState = frame.getTxtBalance();
        txtBalanceState.setEnabled(false);
        txtBalanceState.setText(Integer.toString(this.getAccount().getBalance()));
    }
    ...
    public void initTxtOwnersName(AccountDetailFrame frame) {
        ...
        txtOwnersName.setText(this.getAccount().getOwner().getName());
