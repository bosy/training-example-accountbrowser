...
import com.tieto.academy.accountbrowser.gui.swing.acountdetail.action.FetchAccountDetailsAction;
        ...
        try {
            this.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
            {
                ...
                }
                {
                    ...
                    this.btnFetchAccountDetails.setAction(new FetchAccountDetailsAction("Fetch account details", this));
                }
                {
